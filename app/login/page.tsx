      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-4 text-center text-sm text-gray-500 dark:text-gray-400">
            Connect with your Google account to access YouTube watch history
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 text-xs text-gray-500 dark:text-gray-400 space-y-2">
            <p className="flex items-start gap-2">
              ...
              <span>Access your YouTube watch history to filter out videos you&apos;ve already seen</span>
            </p>
            <p className="flex items-start gap-2">
              <span className="text-green-500 mt-0.5">✓</span>
              <span>Automatically sync your YouTube subscriptions</span>
            </p>
            <p className="flex items-start gap-2">
              <span className="text-green-500 mt-0.5">✓</span>
