...
- Test as we go
- Avoid mocks in tests, prioritise integration testing and testing through playwright etc. 
- Use optimistic design patterns wherever possible for responsive ui
- Suggest improvements to code files you're working on as you work to iterate as we go
